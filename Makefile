...
default: production webmention .jekyll-cache/webmention_io_received.yml
...
site/tags: $(PERSONAL_POSTS_IMPORT_DEST) $(STORY_POSTS_IMPORT_DEST) | docs/.dev/createTags.sh
	@rm -rf site/tags
