...
[![Discord]({{ "/proxy/shields/-/discord/shield.svg" | prepend: site.static_url | absolute_url }}){:loading="lazy" width="64" height="64"}](https://discord.gg/8DCZWGc){:.no-print}
...
[![tumblr]({{ "/proxy/shields/-/tumblr/shield.svg" | prepend: site.static_url | absolute_url }}){:loading="lazy" width="64" height="64"}](https://0xreki.tumblr.com){:.no-print}
...
[![Flattr]({{ "/proxy/shields/-/flattr/shield.svg" | prepend: site.static_url | absolute_url }}){:loading="lazy" width="64" height="64"}](https://flattr.com/@0xReki){:.no-print}
