...
[![YouTubeMusic]({{ "/proxy/shields/-/youtubemusic/shield.svg" | absolute_url }}){:loading="lazy" width="64" height="64"}](https://youtube.com/@RPGRekiMusic){:.no-print rel="me"}
[![BlueSky]({{ "/proxy/shields/-/bluesky/shield.svg" | absolute_url }}){:loading="lazy" width="64" height="64"}](https://bsky.app/profile/rpgreki.vtubers.social){:rel="me atproto"}
[![Matrix]({{ "/proxy/shields/-/matrix/shield.svg" | absolute_url }}){:loading="lazy" width="64" height="64"}](https://matrix.to/#/#bar-desire-sanctuary-mystique:matrix.org){:.no-follow rel="me"}
[![Discord]({{ "/proxy/shields/-/discord/shield.svg" | absolute_url }}){:loading="lazy" width="64" height="64"}](https://discord.gg/fbWpHXu4pC){:.no-print rel="me nofollow"}
...
[![PayPal]({{ "/proxy/shields/-/paypal/shield.svg" | absolute_url }}){:loading="lazy" width="64" height="64"}](https://paypal.me/RPGReki){:rel="me payment nofollow"}
