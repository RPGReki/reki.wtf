...
[![GitHub]({{ "/proxy/shields/-/github/shield.svg" | absolute_url }}){:loading="lazy" width="64" height="64"}](https://github.com/0xReki){:rel="me"}
[![GitLab]({{ "/proxy/shields/-/gitlab/shield.svg" | absolute_url }}){:loading="lazy" width="64" height="64"}](https://gitlab.com/0xReki){:rel="me"}
